...
DEFAULT_CKPT_DIR = os.environ.get(
    'LMD_CKPT_DIR',
    os.path.join(SCRIPT_DIR, 'checkpoints', '8x5_3e-4s_rgb_mine_17_29_46'),
)
...
def main(
    ...
    file_name = "activation_ratio_bn_identity_in_ratio_2_lidar_final_ver_dh2%d.pkl" % global_step
